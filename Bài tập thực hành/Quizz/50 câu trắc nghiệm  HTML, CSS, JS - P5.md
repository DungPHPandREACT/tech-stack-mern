...
Câu 2: Cần thêm tiền tố nào để các thuộc tính CSS3 hoạt động trên trình duyệt Mozilla Firefox cũ?
A. -webkit-
B. -moz-
C. -o-
D. -gecko-
...
Câu 3: Ba giá trị đầu tiên của text-shadow theo thứ tự là gì?
...
Câu 4: 4 giá trị của border-radius lần lượt là?
...
Câu 7: Khi sử dụng thẻ DIV có Class = thì ở phần khai báo CSS ta đặt tên đối tượng thế nào?
...
Câu 10: Biến trong javascript được khai báo thế nào?
A. dim x=5 dim x
B. var x=5; var x;
C. dime x=5 dime x
D. var x=5var
...
Câu 11: Kiểu gán nào sau trong JavaScript không hợp lệ?
A. x = x - y+
B. x *= y
C. x = x + +y
D. x -*=y
...
Câu 12: Xem đoạn mã sau. Thẻ P sẽ có định dạng lại như thế nào? P {color:red;text-align:center;}
...
Câu 13: Để nhúng mã JavaScript trong HTLM ta phải đặt vào vị trí nào sau đây?
A. Trong thẻ <body>
B. Ngay trước <body>
C. Trong thẻ <head>
D. Tất cả
...
Câu 14: Thẻ input type=''text'' … dùng để làm gì?
...
Câu 15: Xem đoạn mã sau. Hãy cho biết ph là gì? #ph {color:red;text-align:center;}
...
Câu 16: Ký hiệu nào sau không hợp lệ?
A. >>
B. <<
C. !=>>
D. >>>
...
Câu 17: Để liên kết các dòng lệnh trong JavaScript thành khối ta sử dụng cách nào?
A. {}
...
Câu 18: Xem đoạn mã sau. Giá trị trong /*This is another comment*/ dùng để làm gì?
/*This is a comment*/
P
{
text-align:center;
...
Câu 19: Khi sử dụng thẻ DIV có ID = thì ở phần khai báo CSS ta đặt tên đối tượng thế nào?
A. Đặt tên đối tượng có dấu . ở đầu tên đối tượng
B. Đặt tên đối tượng có dấu ? ở đầu tên đối tượng
C. Đặt tên đối tượng có dấu $ ở đầu tên đối tượng
D. Đặt tên đối tượng có dấu # ở đầu tên đối tượng
...
Câu 20: Trong CSS muốn tạo một đối tượng có nền màu đỏ, lệnh nào sau đây là đúng
A. backcolor: red;
B. Color: red;
...
Câu 21: Để gộp chuỗi trong JavaScript ta sử dụng ký hiệu nào?
A. +
B. &&
C. ++
D. and
...
Câu 22: Lệnh để liên kết đến 1 file CSS là gì?
...
Câu 23: Sự kiện Onblur xảy ra khi nào?
...
Câu 24: Sự kiện nào sau không có trong Form?
A. Onclick
B. OnBlur
C. Onsubmit
D. Oncharge
...
Câu 25: Thẻ <frameset rows> </framset>:
...
Câu 26: Đặc tính nào sau đây không phải là đặc tính cơ bản của JavaScript?
A. Đơn giản (Simple)
...
Câu 27: Thẻ <frameset cols> </framset>
A. Dùng để chia trang web ra nhiều phần theo cột
B. Dùng để chia trang web ra nhiều phần theo dòng
C. Tất cả dạng trên
D. Không có ý nào ở trên
...
Câu 28: Trong CSS thuộc tính border: solid dùng để mô tả gì?
...
Câu 29: Javascript là ngôn ngữ kịch bản có giấu được mã nguồn không?
...
Câu 30: Sự kiện focus() có ý nghĩa gì?
...
Câu 31: Trong Javascript hàm parseFloatTA() dùng để làm gì?
...
Câu 32: Từ khóa This trong JavaScript thể hiện?
...
Câu 33: Để tạo một khoảng trắng mới ta dùng ký hiệu nào sau đây?
A. \f
B. \b
C. \r
D. \n
...
Câu 34: Đối tượng Parent trong Frames có ý nghĩa?
A. Frame hiện thời
...
Câu 35: Sự kiện MouseOver xảy ra khi nào?
...
Câu 36: Để tạo một tab mới ta dùng ký hiệu nào sau đây?
A. \r
B. \t
C. \f
D. \n
...
Câu 37: Từ nào sau đây không phải là từ khóa trong JavaScript?
A. parseInt
B. parseFloat
C. const
D. continues
...
Câu 38: Để khai báo mảng trong JavaScript ta dùng ký hiệu?
A. ( )
B. [( )]
C. { }
D. [ ]
...
Câu 39: Để chèn thêm 1 ký tự lạ trong JavaScript ví dụ dấu " ta viết theo cách nào?
...
Câu 40: Xét lệnh chmod hello.txt 777 có nghĩa là gì?
A. Lệnh này sai
...
Câu 41: = " Khi sử dụng thẻ DIV có Class = thì ở phần khai báo CSS ta đặt tên đối tượng thế nào?"
...
Câu 42: = " Lệnh CSS có thể viết được ở đâu?"
...
Câu 43: Thẻ của HTML có cấu trúc thế nào?
...
Câu 44: Khi lưu một tài liệu định dạng HTML phần mở rộng có thể là gì?
...
Câu 45: Thẻ trong HTML được viết thế nào?
...
Câu 46: Thuộc tính của các cặp thẻ trong HTML được quy định thế nào?
...
Câu 47: Với các thẻ được quy định về cách thức hiện thị tài liệu, chúng ta có thể can thiệp để thay được được thêm các thông tin đó không?
...
Câu 48: Ngôn ngữ kịch bản Javascript được viết theo:
A. Vbscript
B. Javascript
...
Câu 49: Ngôn ngữ kịch bản Javascript và Java có giống nhau không?
...
Câu 50: Ngôn ngữ kịch bản Javascript gần giống với ngôn ngữ nào sau đây?
A. Pascal
B. Visual Basic
C. C++
D. Foxpro
